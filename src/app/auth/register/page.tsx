    ...
    <main className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">Join Durrah to start booking properties</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          {/* Email registration */}
          {method === 'email' && (
            <form onSubmit={handleEmailRegister} className="flex flex-col gap-4" noValidate>
              <Input
                label="Full name"
                type="text"
                autoComplete="name"
