...
/** Vuesax linear profile-2user — guest count fields (Figma booking card). */
export interface Profile2UserIconProps extends Omit<
...
export function Profile2UserIcon({
  size = 18,
  strokeColor = "#262626",
  className,
  ...rest
}: Profile2UserIconProps) {
  return (
    <svg
      width={size}
      height={size}
