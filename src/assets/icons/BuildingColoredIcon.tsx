...
/**
 * Vuesax linear building (colored variant).
 */
export interface BuildingColoredIconProps extends Omit<
...
export function BuildingColoredIcon({
  size = 24,
  primaryColor = "#2A2F73",
  accentColor = "#FF765E",
  strokeWidth: sw = 1.5,
